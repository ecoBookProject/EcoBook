package com.grupo4.projetointegrador.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.basePackage("com.grupo4.projetointegrador.controller"))
		...
		private static Contact contact() {
			return new Contact("Grupo 4","https://github.com/NicXavier/ProjetoIntegrador.git","weslleysilvapaiva@outlook.com");
		}
